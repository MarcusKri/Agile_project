//USED IF WE WANT TO IMPLEMENT AN EXPIRED MISSION

//IMPORT
import { faBullseye, faGem, faX } from "@fortawesome/free-solid-svg-icons";
...
function ExpiredIcon() {
	return (
		<div class="expiredIcon bg-danger">
